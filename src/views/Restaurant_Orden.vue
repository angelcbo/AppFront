...
export default {
  ...
  methods: {
    agregarOrden() {
      ...
      var TA = document.getElementById("inTA").value;
      var TP = document.getElementById("inTP").value;
      var TM = document.getElementById("inTM").value;

      var BA = document.getElementById("inBA").value;
      var BP = document.getElementById("inBP").value;
      var BM = document.getElementById("inBM").value;
      var beb = document.getElementById("inBeb").value;
      var otra = document.getElementById("inOtro").value;
      this.ordenes.push({
        TAsada: TA,
        TPastor: TP,
        TMolleja: TM,
    ...
    validarOpcion: function(){
      ...
      var bebida = document.getElementById("inBeb").value;
      console.log(bebida);
      var otra = document.getElementById("inOtro").value;
      console.log(otra);
...
console.log(params);
  //    {
      ...
      OrdenesAlimentos.save(params).then(function (response) {
            console.log(response);
        })
        .catch(function (error) {
            console.log(error);
