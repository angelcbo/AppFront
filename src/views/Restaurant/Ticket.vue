            ...
            <table>
                ...
                <tbody>
                    <tr v-for=" item in items "  >
                        ...
                        <td class="price"> ${{calculaPrecio(item.alimento.precio, item.cantidad)}} </td>
                    </tr>
                    <tr>
                        <td class="quantity"></td>
                        <td class="description">TOTAL</td>
                        <td class="price">${{ aPagarTotal }}</td>
                    </tr>
                </tbody>
            </table>
    ...
    methods:{
      ...
      aPagar(){
          ...
          this.orden.resPlatos.forEach(plato => {
              aPagarTotal += _this.calculaPrecio(plato.alimento.precio, plato.cantidad);
          });
